...
<div class="row g-3 mb-3">
    ...
    <div class="col-md-6">
        ...
        <input type="number" step="0.5" name="amount" class="form-control" placeholder="0.0" required>
    </div>
</div>
...
<div class="row g-3 mb-3">
    ...
    <div class="col-md-6">
        <label class="form-label text-muted">Justificatif (Optionnel)</label>
...
<div class="mb-0">
    ...
    <textarea name="objective" class="form-control" style="height: 60px" placeholder="..."></textarea>
</div>